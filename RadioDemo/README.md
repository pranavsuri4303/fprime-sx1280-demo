# RadioDemo Application

This deployment was auto-generated by the F' utility tool.

## Building and Running the RadioDemo Application

In order to build the RadioDemo application, or any other F´ application, we first need to generate a build directory. This can be done with the following commands:
...
The next step is to build the RadioDemo application's code.
```
fprime-util build
```
...
To run the ground system without starting the RadioDemo app:
```
...
```
cd RadioDemo/build-artifacts/<platform>/bin/
./RadioDemo -a 127.0.0.1 -p 50000
```
